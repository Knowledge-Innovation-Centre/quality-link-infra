      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-gray-700 leading-relaxed">
            This dashboard allows you to check if your education institution's 
            data sources were discovered and harvested by the QualityLink aggregator.
          </p>
        </div>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <div className="ml-auto pl-4">
              <svg className="w-10 h-10" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="40" height="40" rx="3" fill="#F3F4F6"/>
                <path d="M20 10v20M10 20h20" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round"/>
                <circle cx="20" cy="20" r="8" stroke="#6B7280" strokeWidth="1.5" fill="none"/>
              </svg>
            </div>
          </label>
        ...
        <div className="flex flex-col gap-3">
          <label className="text-base font-medium text-gray-900">
            Select your institution to start:
          </label>
